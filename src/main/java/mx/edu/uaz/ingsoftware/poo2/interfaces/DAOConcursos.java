...
public interface DAOConcursos {
     ...
     * que ya estan registrados en la sede y concurso especificados por el argumento
     * y que son de la Institucion indicada
     * (para lo cual hay que consultar en la tabla equipos_sede_concurso y equipo)
     * @param idSedeConcurso valor id_sede_concurso a buscar en la tabla equipos_sede_concurso
     ...
     *         ya estan registrados en la sede_concurso especificada
     **/
     ...
     * @param idConcurso ID del concurso donde buscar equipos que aun no se han registrado
     * @param idInstitucion ID de la institucion a la que deben pertenecer los equipos
